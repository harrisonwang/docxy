# Wharf البنية التقنية والمبادئ

توضح هذه الوثيقة الخلفية والمبادئ التقنية وهندسة النظام وتدفق التنفيذ لمشروع Wharf.
...
Wharf هي خدمة وكيل صور تهدف إلى تجاوز الحصار الشبكي وتسريع تنزيلات الصور عن طريق استضافة وكيل ذاتي.
...
ينفذ Wharf وكيلًا كاملاً لواجهة برمجة تطبيقات سجل Docker، ويتطلب فقط إضافة تكوين وكيل في عميل Docker لاستخدامه.
...
sequenceDiagram
    ...
    participant Proxy as وكيل Wharf
